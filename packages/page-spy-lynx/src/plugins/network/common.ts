import { isString, isTypedArray, toStringTag } from "@huolala-tech/page-spy-base/dist/utils";
...
export function addContentTypeHeader(
  ...
  const headerTuple = [CONTENT_TYPE_HEADER, bodyContentType] as [string, string];
  if (!headers) {
    return [headerTuple];
  }
